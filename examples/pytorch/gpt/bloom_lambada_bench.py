...
@torch.no_grad()
def main_bench(batch_size, input_len, output_len):
    ...
    for entries in data_loader:
        ...
        input_lengths = torch.tensor([input_len for i in range(batch_size)]).int()
...
if __name__ == "__main__":
    ...
    main_bench(1, 128, 128)
    main_bench(1, 128, 512)
    main_bench(1, 128, 1024)

    main_bench(4, 128, 128)
    main_bench(4, 128, 512)
    main_bench(4, 128, 1024)

    main_bench(16, 128, 128)
    main_bench(16, 128, 512)
    main_bench(16, 128, 1024)
