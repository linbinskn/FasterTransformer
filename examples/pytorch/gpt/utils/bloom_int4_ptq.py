...
for name, param in model.items():
    if 'query_key_value.weight' in name or 'dense.weight' in name or 'dense_h_to_4h.weight' in name or 'dense_4h_to_h.weight' in name:
...
torch.save(q_model, 'bloom-540m-w4-bin.pt')
